...
import com.foodies.vedriver.databinding.ActivitySignupBinding;
...
import com.foodies.vedriver.utils.AppUtils;
...
public class SignupActivity extends AppCompatActivity {
    ...
    void hitSignUp() {
        ...
        mSignupViewModel.getData(SignupActivity.this, param).observe(this, new Observer<UserModel>() {
            @Override
            public void onChanged(UserModel apiResponseModel) {
            }
        });
